...
!(function () {
  ...
  class Sn {
    ...
    ju(t, i) {
      const n = this.Vu(t),
        ...
        e = s + i * (s / 10);
      this.Gn(e),
        this.cn.rightBarStaysOnScroll || this.Jn(this.Iu() + (n - this.Vu(t)));
    }
    Uo(t) {
      this.fo && this.Zo(),
        null === this.do &&
          null === this.du &&
          (this.Fi() || ((this.do = t), this.Hu()));
    }
    qo(t) {
    ...
    Nu(t) {
      ...
      return (
        void 0 === i &&
          ((i = new mn((t) => this.lc(t), this.N_)), this.lu.set(t.weight, i)),
        i.F_(t)
      );
    }
    lc(t) {
  ...
  class kn {
    constructor(t) {
      (this.bt = !0),
        (this.jt = { Tt: !1, O: "", oc: [], cc: "center", dc: "center" }),
  ...
  class An {
    constructor(t, i, n) {
      (this.mc = []),
        ...
        (this.kc = new Xi(i.crosshair)),
        (this.Cc = new Cn(this, i.watermark)),
        this.Tc(),
        this.mc[0].p_(2e3),
        (this.Pc = this.Rc(0)),
        (this.Dc = this.Rc(1));
    ...
    Jc(t, i, n, s, e) {
      ...
      null !== o && (r = a.pn(i, o)),
        ...
        this.wt.yn(h, r, s),
        this.sa(),
        e || this.Mc.m(this.wt.yt(), { x: t, y: i }, n);
    }
    Qc(t, i, n) {
      const s = n.vn(),
        e = s.Pt(),
    ...
    zt(t) {
      ...
      if (
        ...
        null === this.xc || this.xc.Ts !== n || this.xc.Ps !== i)
      )
        this.xc = { Ts: n, Ps: i, _d: new Map() };
      else {
    ...
    rd(t, i, n, s) {
      const e = new Yi(this, t, i, n, s),
        r = void 0 !== t.priceScaleId ? t.priceScaleId : this.ad();
  ...
  function Un(t, i) {
    ...
    for (let n = Hn.length - 1; n >= 0; --n)
      if (
        Math.floor(i.getTime() / Hn[n].xd) !==
        Math.floor(t.getTime() / Hn[n].xd)
      )
        return Hn[n].Sd;
    return 0;
  }
  ...
  class Zn {
    ...
    key(t) {
      return "object" == typeof t && "yd" in t
        ? t.yd
    ...
    cacheKey(t) {
      ...
      return void 0 === i.kd
        ...
        : new Date(Date.UTC(i.kd.year, i.kd.month - 1, i.kd.day)).getTime();
    }
    ...
    formatTickmark(t, i) {
      ...
      return (function (t, i, n) {
        ...
        const e =
          void 0 === t.kd
            ? new Date(1e3 * t.yd)
            : new Date(Date.UTC(t.kd.year, t.kd.month - 1, t.kd.day));
        return new Date(
          e.getUTCFullYear(),
          e.getUTCMonth(),
          e.getUTCDate(),
  ...
  class _s {
    ...
    Dr(t, i) {
      ...
      let n = 0;
      const s = os(this.Rd, this.Dd, this.Id),
        e = as(this.Rd, this.Dd),
        r = [s],
        h = [e];
      if (((n += e), null !== this.Od)) {
  ...
  class ps {
    ...
    Ef(t) {
      const i = Ms(t.changedTouches, f(this.df));
      if (null === i) return;
      if (((this.cf = gs(t)), null !== this.hf)) return;
      if (this._f) return;
      this.af = !0;
      const n = this.Mf(ws(i), f(this.Zd)),
        { If: s, Lf: e, gf: r } = n;
      if (this.Gd || !(r < 5)) {
        if (!this.Gd) {
          const t = 0.5 * s,
        ...
        if (!this._f) {
          const n = this.wf(t, i);
          this.xf(n, this.yf.Wf), bs(t);
        }
      }
    }
    jf(t) {
      if (0 !== t.button) return;
      const i = this.Mf(ws(t), f(this.Kd)),
        { gf: n } = i;
    ...
    $f(t) {
      let i = Ms(t.changedTouches, f(this.df));
      if (
      ...
      if ((this.xf(n, this.yf.Uf), ++this.$d, this.Ud && this.$d > 1)) {
        const { gf: t } = this.Mf(ws(i), this.qd);
        t < 30 && !this.Qd && this.xf(n, this.yf.Sf), this.kf();
      } else this.Qd || (this.xf(n, this.yf.qf), this.yf.qf && bs(t));
      0 === this.$d && bs(t),
        0 === t.touches.length && this.Xd && ((this.Xd = !1), bs(t));
    }
    pf(t) {
      if (0 !== t.button) return;
      const i = this.wf(t);
      ...
      if (!this.bf(t))
        if ((this.Cf(i, this.yf.Yf), ++this.Wd, this.jd && this.Wd > 1)) {
          const { gf: n } = this.Mf(ws(t), this.Hd);
          n < 5 && !this.Jd && this.Cf(i, this.yf.Tf), this.Pf();
    ...
    Kf(t) {
      ...
      (this.df = i.identifier), (this.cf = gs(t));
        ...
        this.rf && (this.rf(), (this.rf = null));
      {
        ...
        (this.rf = () => {
          ...
          this.Of(),
          (this.Yd = setTimeout(this.Zf.bind(this, t), 240));
      }
      const s = this.wf(t, i);
      this.xf(s, this.yf.Gf),
        this.Ud ||
          ((this.$d = 0),
          (this.Ud = setTimeout(this.kf.bind(this), 500)),
          (this.qd = ws(i)));
    }
    Jf(t) {
      if (0 !== t.button) return;
      const i = this.Rf.ownerDocument.documentElement;
      rs() && i.addEventListener("mouseleave", this.vf),
        (this.Jd = !1),
        (this.Kd = ws(t)),
        this.ef && (this.ef(), (this.ef = null));
      {
        const t = this.jf.bind(this),
          n = this.pf.bind(this);
        (this.ef = () => {
      ...
      const n = this.wf(t);
      this.Cf(n, this.yf.Qf),
        this.jd ||
          ((this.Wd = 0),
          (this.jd = setTimeout(this.Pf.bind(this), 500)),
          (this.Hd = ws(t)));
    }
    Df() {
      this.Rf.addEventListener("mouseenter", this.Af.bind(this)),
        this.Rf.addEventListener("touchcancel", this.Of.bind(this));
      {
        const t = this.Rf.ownerDocument,
          i = (t) => {
            this.yf.tv &&
              ((t.composed && this.Rf.contains(t.composedPath()[0])) ||
      ...
      hs() &&
        ...
        this.Rf.addEventListener("dblclick", this.mf)),
        this.Rf.addEventListener("mouseleave", this.iv.bind(this)),
        this.Rf.addEventListener("touchstart", this.Kf.bind(this), {
          passive: !0,
        }),
        vs(this.Rf),
        this.Rf.addEventListener("mousedown", this.Jf.bind(this)),
        this.nv(),
    ...
    nv() {
      (void 0 === this.yf.sv &&
        void 0 === this.yf.ev &&
        void 0 === this.yf.rv) ||
        (this.Rf.addEventListener("touchstart", (t) => this.hv(t.touches), {
          passive: !0,
        }),
        this.Rf.addEventListener(
          ...
          (t) => {
            if (
              ...
              const i = ms(t.touches[0], t.touches[1]) / this.lf;
              this.yf.ev(this.hf, i), bs(t);
            }
          },
          { passive: !1 }
        ),
    ...
    hv(t) {
      1 === t.length && (this.af = !1),
        2 !== t.length || this.af || this.Xd ? this.lv() : this.av(t);
    }
    av(t) {
      ...
      (this.hf = {
        ...
        (this.lf = ms(t[0], t[1])),
        void 0 !== this.yf.sv && this.yf.sv(),
        this.Of();
    }
    lv() {
      null !== this.hf &&
        ((this.hf = null), void 0 !== this.yf.rv && this.yf.rv());
    }
    iv(t) {
    ...
    Zf(t) {
      const i = Ms(t.touches, f(this.df));
      if (null === i) return;
      const n = this.wf(t, i);
  ...
  class ks {
    constructor(t, i, n, s) {
      (this.Li = null),
        ...
        (this.Ov.style.height = "100%"),
        (this.Ov.style.overflow = "hidden"),
        (this.Ov.style.width = "25px"),
        (this.Ov.style.left = "0"),
        (this.Ov.style.position = "relative"),
        (this.Av = us(this.Ov, Gn({ width: 16, height: 16 }))),
      ...
      (e.style.position = "absolute"),
        ...
        (e.style.left = "0"),
        (e.style.top = "0"),
        (this.Bv = us(this.Ov, Gn({ width: 16, height: 16 }))),
      ...
      this.Wv = new ps(this.Bv.canvasElement, h, {
        Nf: () => !this.cn.handleScroll.vertTouchDrag,
        Ff: () => !0,
      });
    }
    S() {
      this.Wv.S(),
        this.Bv.unsubscribeSuggestedBitmapSizeChanged(this.Cv),
        this.Bv.dispose(),
        this.Av.unsubscribeSuggestedBitmapSizeChanged(this.yv),
        this.Av.dispose(),
    ...
    $v() {
      ...
      let t = 0;
      const i = this.Hv(),
        n = f(this.Av.canvasElement.getContext("2d"));
      n.save();
      const s = this.Li.Ia();
      (n.font = this.Uv()),
        s.length > 0 &&
      ...
      if (null !== r && null !== this.wv) {
        const i = this.Li.pn(1, r),
          s = this.Li.pn(this.wv.height - 2, r);
        t = Math.max(
          t,
          this.Mv.Si(
            n,
    ...
    Yv(t) {
      (null !== this.wv && Jn(this.wv, t)) ||
        ((this.wv = t),
        (this.Sv = !0),
        this.Av.resizeCanvasElement(t),
        this.Bv.resizeCanvasElement(t),
        (this.Sv = !1),
        (this.Ov.style.width = `${t.width}px`),
        (this.Ov.style.height = `${t.height}px`));
    }
    Xv() {
    ...
    Zv(t) {
      ...
      if (1 !== t) {
        ...
        null !== t &&
          ...
          this.nn.Qv(t, this.Dv),
          this.tp(t),
          this.nn.Qv(t, this.Pv),
          this.ip(t));
      }
    ...
    Nv(t) {
      ...
      !this.nn.kv().qt().W().handleScale.axisPressedMouseMove.price ||
        this.Li.ph() ||
        this.Li.Co() ||
        this.rp(1);
    }
          ...
          (t.font = this.Uv()),
            (t.fillStyle =
              null !== (r = n.textColor) && void 0 !== r
                ? r
                : this.mo.textColor),
            (t.textAlign = this.Tv ? "right" : "left"),
            (t.textBaseline = "middle");
  ...
  class Ds {
    constructor(t, i) {
      (this.wv = Gn({ width: 0, height: 0 })),
        ...
        (this.gp = t),
        (this.wp = i),
        this.wp.z_().l(this.Mp.bind(this), this, !0),
        (this.xp = document.createElement("td")),
        (this.xp.style.padding = "0"),
        (this.xp.style.position = "relative");
      ...
      (e.style.position = "absolute"),
        ...
        (e.style.left = "0"),
        (e.style.top = "0"),
        (this.kp = document.createElement("tr")),
        this.kp.appendChild(this.Sp),
        this.kp.appendChild(this.xp),
        this.kp.appendChild(this.yp),
        this.Cp(),
        (this.Wv = new ps(this.Bv.canvasElement, this, {
    ...
    S() {
      null !== this.lp && this.lp.S(),
        ...
        this.Av.unsubscribeSuggestedBitmapSizeChanged(this.yv),
        this.Av.dispose(),
        null !== this.wp && this.wp.z_().p(this),
        this.Wv.S();
    }
    Kv() {
      return f(this.wp);
    ...
    Tp(t) {
      null !== this.wp && this.wp.z_().p(this),
        (this.wp = t),
        null !== this.wp &&
          this.wp.z_().l(Ds.prototype.Mp.bind(this), this, !0),
        this.Cp();
    }
    kv() {
      return this.gp;
    ...
    zf(t) {
      ...
      const e = this.br(n, s);
      this.gp.Bp(
        null !== (i = null == e ? void 0 : e.bv) && void 0 !== i ? i : null
      ),
        this.Ui().Vc(e && { zc: e.zc, pv: e.pv });
    }
    Xf(t) {
    ...
    Uf(t) {
      0 === this.kv().W().trackingMode.exitMode && (this.pp = !0),
        this.jp(),
        this.Ip(t);
    }
    br(t, i) {
      ...
      return null === n
        ...
        : (function (t, i, n) {
            ...
            if ("top" === (null == e ? void 0 : e.mv.zOrder)) return xs(e);
            for (const r of s) {
              if (
                e &&
                e.zc === r &&
            ...
            return (null == e ? void 0 : e.mv) ? xs(e) : null;
          })(n, t, i);
    }
    Hp(t, i) {
      f("left" === i ? this.lp : this.ap).Yv(
        Gn({ width: t, height: this.wv.height })
      );
    }
    $p() {
      return this.wv;
    ...
    Yv(t) {
      Jn(this.wv, t) ||
        ...
        this.Bv.resizeCanvasElement(t),
        (this.Sv = !1),
        (this.xp.style.width = t.width + "px"),
        (this.xp.style.height = t.height + "px"));
    }
    Up() {
      const t = f(this.wp);
      t.x_(t.S_()), t.x_(t.y_());
    ...
    Zv(t) {
      ...
      if (
        (t > 1 && this.Up(),
        null !== this.lp && this.lp.Zv(t),
        null !== this.ap && this.ap.Zv(t),
        1 !== t)
      ) {
    ...
    Xp(t) {
      const i = this.Ui().Nc();
      this.Jp(t, Ts, cs, i), this.Jp(t, Ts, ds, i);
    }
    Kp(t) {
      this.Jp(t, Ts, ds, this.Ui().Fc());
    }
    qp(t, i) {
      const n = f(this.wp).No();
      for (const s of n) this.Jp(t, i, cs, s);
    ...
    Pp() {
      if (null === this.wp) return;
      const t = this.gp,
        i = this.wp.S_().W().visible,
        n = this.wp.y_().W().visible;
      i ||
        null === this.lp ||
        (this.Sp.removeChild(this.lp.jv()), this.lp.S(), (this.lp = null)),
        n ||
          null === this.ap ||
          (this.yp.removeChild(this.ap.jv()), this.ap.S(), (this.ap = null));
      const s = t.qt().sd();
      i &&
        null === this.lp &&
        ((this.lp = new ks(this, t.W(), s, "left")),
        this.Sp.appendChild(this.lp.jv())),
        n &&
          null === this.ap &&
          ((this.ap = new ks(this, t.W(), s, "right")),
          this.yp.appendChild(this.ap.jv()));
    }
    Qp(t) {
    ...
    Ep(t) {
      ...
      const s = this.gp.W(),
        ...
        r = s.kineticScroll;
      if (
        (!e.pressedMouseMove || t.uv) &&
        ((!e.horzTouchDrag && !e.vertTouchDrag) || !t.uv)
      )
        return;
      const h = this.wp.vn(),
        l = performance.now();
      if (
        ...
        null !== this.op &&
          !this._p &&
          (this.op.x !== t.clientX || this.op.y !== t.clientY))
      ) {
        if ((t.uv && r.touch) || (!t.uv && r.mouse)) {
          const t = n.he();
          (this.bp = new _s(0.2 / t, 7 / t, 0.997, 15 / t)),
            this.bp.Nd(n.Iu(), this.op.yd);
        } else this.bp = null;
        h.Fi() || i.P_(this.wp, h, t.localY), i.Yc(t.localX), (this._p = !0);
      }
      this._p &&
        (h.Fi() || i.R_(this.wp, h, t.localY),
        i.Xc(t.localX),
        null !== this.bp && this.bp.Nd(n.Iu(), l));
    }
  }
  class Os {
    constructor(t, i, n, s, e) {
    ...
    S() {
      this.Av.unsubscribeSuggestedBitmapSizeChanged(this.yv), this.Av.dispose();
    }
    jv() {
      return this.Ov;
    }
  ...
  class Es {
    constructor(t, i) {
      (this.lm = null),
        ...
        (this.N_ = i),
        (this.cn = t.W().layout),
        (this.um = document.createElement("tr")),
        (this.dm = document.createElement("td")),
        (this.dm.style.padding = "0"),
        (this.fm = document.createElement("td")),
        (this.fm.style.padding = "0"),
        (this.Ov = document.createElement("td")),
        (this.Ov.style.height = "25px"),
        (this.Ov.style.padding = "0"),
        ...
        this.Ov.appendChild(this.vm),
        (this.Av = us(this.vm, Gn({ width: 16, height: 16 }))),
        this.Av.subscribeSuggestedBitmapSizeChanged(this.yv);
      ...
      (n.style.position = "absolute"),
        ...
        (n.style.left = "0"),
        (n.style.top = "0"),
        (this.Bv = us(this.vm, Gn({ width: 16, height: 16 }))),
        this.Bv.subscribeSuggestedBitmapSizeChanged(this.Cv);
      ...
      (s.style.position = "absolute"),
        ...
        (s.style.left = "0"),
        (s.style.top = "0"),
        this.um.appendChild(this.dm),
        this.um.appendChild(this.Ov),
        this.um.appendChild(this.fm),
        this.pm(),
        this.gp.qt().f_().l(this.pm.bind(this), this),
        (this.Wv = new ps(this.Bv.canvasElement, this, {
          Nf: () => !0,
    ...
    Qf(t) {
      ...
      const i = this.gp.qt();
      !i.kt().Fi() &&
        this.gp.W().handleScale.axisPressedMouseMove.time &&
        i.$c(t.localX);
    }
    Gf(t) {
      this.Qf(t);
    ...
    tv() {
      ...
      !t.kt().Fi() &&
        this.om &&
        ((this.om = !1),
        this.gp.W().handleScale.axisPressedMouseMove.time && t.Gc());
    }
    Hf(t) {
      const i = this.gp.qt();
      !i.kt().Fi() &&
    ...
    Yf() {
      this.om = !1;
      const t = this.gp.qt();
      (t.kt().Fi() && !this.gp.W().handleScale.axisPressedMouseMove.time) ||
        t.Gc();
    }
    Uf() {
      this.Yf();
    ...
    Mm(t, i, n) {
      Jn(this.wv, t) ||
        ...
        (this.Ov.style.height = `${t.height}px`),
        this._m.m(t)),
        null !== this.lm && this.lm.Yv(Gn({ width: i, height: t.height })),
    ...
    Zv(t) {
      ...
      if (1 !== t) {
        ...
        null !== i &&
          (i.useBitmapCoordinateSpace((t) => {
            this.Jv(t), this.Ve(t), this.km(i, zs);
          }),
          this.tp(i),
          this.km(i, Bs)),
          null !== this.lm && this.lm.Zv(t),
          null !== this.am && this.am.Zv(t);
      }
      this.Bv.applySuggestedBitmapSize();
      const i = ss(this.Bv);
      null !== i &&
        ...
        this.Cm([...this.gp.qt().Mt(), this.gp.qt().Fc()], i),
        this.km(i, Vs));
    }
    km(t, i) {
    ...
    Pm(t, i, n) {
      const s = this.Mv.Si(t, n),
        e = s / 2,
        r = Math.floor(i - e) + 0.5;
      return (
        r < 0
          ? (i += Math.abs(0 - r))
          : r + s > this.wv.width && (i -= Math.abs(this.wv.width - (r + s))),
        i
      );
    }
    Cm(t, i) {
    ...
    pm() {
      ...
      i.leftPriceScale.visible ||
        null === this.lm ||
        (this.dm.removeChild(this.lm.jv()), this.lm.S(), (this.lm = null)),
        i.rightPriceScale.visible ||
          null === this.am ||
          (this.fm.removeChild(this.am.jv()), this.am.S(), (this.am = null));
      const n = { sd: this.gp.qt().sd() },
        s = () => i.leftPriceScale.borderVisible && t.kt().W().borderVisible,
        e = () => t.od();
      i.leftPriceScale.visible &&
        null === this.lm &&
        ((this.lm = new Os("left", i, n, s, e)),
        this.dm.appendChild(this.lm.jv())),
        i.rightPriceScale.visible &&
          null === this.am &&
          ((this.am = new Os("right", i, n, s, e)),
          this.fm.appendChild(this.am.jv()));
    }
  }
  const Is =
    !!es &&
  ...
  class Ns {
    constructor(t, i, n) {
      ...
      (this.Dm = []),
        ...
        (this.cn = i),
        (this.N_ = n),
        (this.um = document.createElement("div")),
        this.um.classList.add("tv-lightweight-charts"),
        (this.um.style.overflow = "hidden"),
        (this.um.style.direction = "ltr"),
        (this.um.style.width = "100%"),
        (this.um.style.height = "100%"),
        ((s = this.um).style.userSelect = "none"),
        ...
        this.um.appendChild(this.Nm),
        (this.Fm = this.Wm.bind(this)),
        Fs(this.cn) && this.jm(!0),
        (this.Ui = new An(this.Sc.bind(this), this.cn, n)),
        this.qt().Wc().l(this.Hm.bind(this), this),
        (this.$m = new Es(this, this.N_)),
        this.Nm.appendChild(this.$m.jv());
      ...
      this.qm(r, h),
        this.Ym(),
        t.appendChild(this.um),
        this.Xm(),
        this.Ui.kt().Gu().l(this.Ui.$l.bind(this.Ui), this),
    ...
    S() {
      this.jm(!1),
        ...
        this.Ui.Wc().p(this),
        this.Ui.kt().Gu().p(this),
        this.Ui.f_().p(this),
        this.Ui.S();
      for (const t of this.Dm)
        this.Nm.removeChild(t.jv()), t.Fp().p(this), t.Wp().p(this), t.S();
      (this.Dm = []),
        f(this.$m).S(),
        null !== this.um.parentElement &&
          this.um.parentElement.removeChild(this.um),
        this.Mc.S(),
        this.up.S(),
        this.cp.S(),
        this.Gm();
    ...
    qm(t, i, n = !1) {
      ...
      const e = this.Qa + "px",
        r = this.e_ + "px";
      (f(this.um).style.height = e),
        (f(this.um).style.width = r),
        (this.Nm.style.height = e),
        (this.Nm.style.width = r),
        n ? this.Jm(at.es(), performance.now()) : this.Ui.$l();
    }
    Zv(t) {
      void 0 === t && (t = at.es());
    ...
    tb() {
      null !== this.Vm &&
        (this.Jm(this.Vm, performance.now()), (this.Vm = null));
      const t = this.ib(null),
    ...
    Bp(t) {
      (this.Im = t),
        this.Im
          ? this.hb().style.setProperty("cursor", t)
          : this.hb().style.removeProperty("cursor");
    }
    lb() {
      return this.Im;
    }
    ...
    Qm(t) {
      (void 0 !== t.autoSize ||
        ...
        (t.autoSize && !this.Em && this.Um(),
        !1 === t.autoSize && null !== this.Em && this.Gm(),
        t.autoSize ||
          (void 0 === t.width && void 0 === t.height) ||
          this.qm(t.width || this.e_, t.height || this.Qa));
    }
    ib(t) {
      let i = 0,
        n = 0;
      ...
      if (this.cn.timeScale.visible) {
        ...
        if (null !== t) {
          let e = 0;
          this.sb() && (r("left", e, n), (e = f(s.Zp()).sp().width)),
            this.$m.ep(t, e, n),
            (e += i.width),
            this.eb() && r("right", e, n);
        }
    ...
    ob() {
      ...
      for (let t = 0; t < this.Dm.length; ++t) {
        ...
        let e = 0,
          h = 0;
        (h = t === this.Dm.length - 1 ? _ - c : Math.round(s.v_() * u)),
          (e = Math.max(h, 2)),
          (c += e),
          s.Yv(Gn({ width: r, height: e })),
          this.sb() && s.Hp(i, "left"),
          this.eb() && s.Hp(n, "right"),
          s.Kv() && this.Ui.jc(s.Kv(), e);
      }
      this.$m.Mm(Gn({ width: h ? r : 0, height: l }), h ? i : 0, h ? n : 0),
        this.Ui.m_(r),
        this.Am !== i && (this.Am = i),
        this.Bm !== n && (this.Bm = n);
    }
    jm(t) {
      t
        ? this.um.addEventListener("wheel", this.Fm, { passive: !1 })
        : this.um.removeEventListener("wheel", this.Fm);
    }
    _b(t) {
      switch (t.deltaMode) {
    ...
    Wm(t) {
      ...
      if (
        ...
        const i = Math.sign(s) * Math.min(1, Math.abs(s)),
          n = t.clientX - this.um.getBoundingClientRect().left;
        this.qt().Uc(n, i);
      }
    ...
    Jm(t, i) {
      ...
      3 === s && this.ub(),
        (3 !== s && 2 !== s) ||
          ...
          3 === (null === (n = this.Vm) || void 0 === n ? void 0 : n.jn()) &&
            (this.Vm.ts(t),
            this.ub(),
            this.cb(this.Vm),
            this.fb(this.Vm, i),
    ...
    Sc(t) {
      null !== this.Vm ? this.Vm.ts(t) : (this.Vm = t),
        this.zm ||
          ((this.zm = !0),
    ...
    Ym() {
      ...
      for (let s = n; s < i; s++) {
        ...
        i.Fp().l(this.vb.bind(this), this),
          ...
          this.Dm.push(i),
          this.Nm.insertBefore(i.jv(), this.$m.jv());
      }
      for (let n = 0; n < i; n++) {
        const i = t[n],
          s = this.Dm[n];
    ...
    mb(t, i, n) {
      ...
      const h = this.qt().Bc(),
        l = null !== h && h.zc instanceof Yi ? h.zc : void 0,
  ...
  function Ys(t, i, n, s, e) {
    const r = d(e)(n),
      ...
      _ = n,
      { time: u, color: c } = _;
    return { se: i, ut: t, Bt: o, bb: s, He: Ws(_, ["time", "color"]), O: c };
  }
  function Xs(t) {
    return void 0 !== t.Bt;
  }
  ...
  function Qs(t, i) {
    if (void 0 !== t && 0 !== t.length)
      return { Cb: i.key(t[0].ut), Tb: i.key(t[t.length - 1].ut) };
  }
  function te(t) {
    let i;
    return (
  ...
  class ie {
    ...
    Ab(t, i) {
      let n = 0 !== this.Pb.size,
        s = !1;
      const e = this.Rb.get(t);
      if (void 0 !== e)
        if (1 === this.Rb.size) (n = !1), (s = !0), this.Pb.clear();
        else for (const i of this.Ob) i.pointData.kb.delete(t) && (s = !0);
      let r = [];
      if (0 !== i.length) {
        ...
        r = i.map((i, r) => {
          const o = e(i.time),
            _ = this.N_.key(o);
          let u = this.Pb.get(_);
          void 0 === u && ((u = Js(o)), this.Pb.set(_, u), (s = !0));
    ...
    Ib(t, i) {
      ...
      const h = void 0 === r;
      void 0 === r && ((r = Js(s)), this.Pb.set(this.N_.key(s), r));
      const l = Gs(t.Xh()),
        a = t.ga(),
        o = t.Ma(),
        _ = l(s, r.se, i, n.bb, a, o);
    ...
    Vb(t, i) {
      0 !== i.length
        ? (this.Rb.set(t, i.filter(Xs)), this.Db.set(t, i[i.length - 1].ut))
        : (this.Rb.delete(t), this.Db.delete(t));
    }
    Bb() {
      for (const t of this.Ob)
        0 === t.pointData.kb.size && this.Pb.delete(this.N_.key(t.time));
    }
    zb(t) {
      let i = -1;
      ...
      if (
        (-1 === i &&
          this.Ob.length !== t.length &&
          (i = Math.min(this.Ob.length, t.length)),
        -1 === i)
      )
        return -1;
    ...
    Eb(t, i, n) {
      ...
      if (-1 !== i)
        this.Rb.forEach((i, e) => {
          ...
          this.Rb.has(t) || s.Fb.set(t, { He: [], Wb: n }),
          (s.kt.jb = this.Ob),
          (s.kt.Hb = i);
      else {
  ...
  class ye {
    constructor(t, i, n) {
      (this.tw = new k()),
        ...
        this.wl.Zu().l(this.nw.bind(this)),
        this.$m.gm().l(this.sw.bind(this)),
        (this.N_ = n);
    }
    S() {
      this.wl.Ku().p(this),
  ...
  class Te {
    constructor(t, i, n) {
      ...
      const e = this.$b.qt();
      this.uw = new ye(e, this.$b.Zm(), this.N_);
    }
    remove() {
      this.$b.Fp().p(this),
        this.$b.Wp().p(this),
    ...
    cw(t, i, n = {}, s) {
      ke(n.priceFormat);
      const e = C(O(l), O(i), n),
        r = this.$b.qt().ed(t, e, s),
        h = new Se(r, this, this, this, this.N_);
      return this.ew.set(h, r), this.rw.set(r, h), h;
    }
    dw(t) {
      const i = this.$b.qt();
      i.nd(t.kt.Au, t.kt.jb, t.kt.Hb),
        t.Fb.forEach((t, i) => i.it(t.He, t.Wb)),
        i.zu();
    }
    fw(t) {
